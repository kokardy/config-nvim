...
local mappings = {
  ...
  ["d"] = {
    ...
    B = { "<cmd>lua require('dap').set_breakpoint(nil, nil, vim.fn.input('Breakpoint condition: '))<CR>",
      "set breakpoint contidion" },
    m = { "<cmd>lua require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<CR>",
      "set breakpoint messege" },
  ...
  ["/"] = { "<Plug>(comment_toggle_linewise_current)<CR>", "Toggle Comment" },
